...
global = { \time 3/4 \key es \major }

\score {
  <<
  \new Staff \relative c' { \global
    <d g bes>4 <e g c> <g g cis> <f a d> <es as es'> <fis a d> <g bes d>2.
  }
  \new Staff \new Voice = "bs" \relative c { \clef bass \global
    g4 e' es d c d g,2.
  }
  \figures {
    <_>4 <6> <6+> <_> <6-> <_+>
  ...
  \new Lyrics \lyricsto "bs" {
    \set stanza = "in Gm:" 
    i \markup \rN { IV 6} \markup \rN {IT 6+ / v } v \markup \rN {N 6} V i
  }
  >>
  \layout {}
  \midi {}
